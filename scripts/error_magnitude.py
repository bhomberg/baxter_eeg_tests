...
def run_experiment(num_trials, args):
	...
	# order: position 1 is max left, 5 is max right
        down = [[-1.25, 0.39, 0.23, 0.01, -0.25, -0.37, -0.14], [-.72, .29, .67, .27, -.08, -.44, -.48], [-.72, .29, .67, .27, -.08, -.44, -.48], [-.72, .29, .67, .27, -.08, -.44, -.48], [-.72, .29, .67, .27, -.08, -.44, -.48]]
